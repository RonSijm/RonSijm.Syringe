...
public sealed class MicrosoftServiceProvider : IKeyedServiceProvider, IDisposable, IAsyncDisposable
{
    ...
    internal static bool DisableDynamicEngine { get; } =
        AppContext.TryGetSwitch("Microsoft.Extensions.DependencyInjection.DisableDynamicEngine", out var disableDynamicEngine) ? disableDynamicEngine : false;
    ...
    internal MicrosoftServiceProvider(ICollection<ServiceDescriptor> serviceDescriptors, ServiceProviderOptions options)
    {
        ...
        if (options.RegisterServiceScopeFactory)
        {
    ...
    internal sealed class ServiceProviderDebugView
    {
        ...
        public ServiceProviderDebugView(MicrosoftServiceProvider serviceProvider)
        {
            _serviceProvider = serviceProvider;
        }

        public List<ServiceDescriptor> ServiceDescriptors => [.._serviceProvider.Root.RootProvider.CallSiteFactory.Descriptors];
        public List<object> Disposables => [.._serviceProvider.Root.Disposables];
