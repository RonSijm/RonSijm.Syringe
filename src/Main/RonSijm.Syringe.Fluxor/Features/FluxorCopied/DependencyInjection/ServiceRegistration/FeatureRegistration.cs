            ...
            services.Add(info.FeatureInterfaceGenericType, serviceProvider =>
                {
                    ...
                    {
                        var featureConstructor = info.FeatureWrapperGenericType.GetConstructor(new Type[] { typeof(FeatureStateInfo), typeof(IDispatcher) });
                    ...
                    {
                        var featureConstructor = info.FeatureWrapperGenericType.GetConstructor(new Type[] { typeof(FeatureStateInfo) });
