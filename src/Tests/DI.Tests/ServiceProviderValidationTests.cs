...
public class ServiceProviderValidationTests
{
    ...
    public void BuildServiceProvider_ValidateOnBuild_Throws_WhenScopedIsInjectedIntoSingleton()
    {
        ...
        Assert.Equal("Error while validating the service descriptor 'ServiceType: MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+IFoo Lifetime: Singleton ImplementationType: MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+Foo': " +
                     "Cannot consume scoped service 'MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+IBar' from singleton 'MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+IFoo'."
    ...
    public void BuildServiceProvider_ValidateOnBuild_Throws_WhenScopedIsInjectedIntoSingleton_CachedCallSites()
    {
        ...
        Assert.Equal("Error while validating the service descriptor 'ServiceType: MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+Foo2 Lifetime: Singleton ImplementationType: MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+Foo2': " +
                     "Cannot consume scoped service 'MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+IBar' from singleton 'MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+Foo2'."
            , aggregateException.InnerExceptions[0].Message);
    }
    ...
    public void BuildServiceProvider_ValidateOnBuild_ThrowsForUnresolvableServices()
    {
        ...
        Assert.Equal("Error while validating the service descriptor 'ServiceType: MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+IFoo Lifetime: Transient ImplementationType: MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+Foo': " +
                     "Unable to resolve service for type 'MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+IBar' while attempting to activate" +
                     " 'MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+Foo'.",
            aggregateException.InnerExceptions[0].Message);

        Assert.Equal("Error while validating the service descriptor 'ServiceType: MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+IBaz Lifetime: Transient ImplementationType: MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+BazRecursive': " +
                     "A circular dependency was detected for the service of type 'MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+IBaz'." + Environment.NewLine +
                     "MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+IBaz(MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+BazRecursive) ->" +
                     " MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+IBaz",
    ...
    public void BuildServiceProvider_ValidateOnBuild_ThrowsWhenImplementationIsNotAssignableToService()
    {
        ...
        Assert.Equal("Error while validating the service descriptor 'ServiceType: MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+IBaz Lifetime: Transient ImplementationType: MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+Boo': " +
                     "Implementation type 'MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+Boo' can't be converted to service type 'MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+IBaz'",
            aggregateException.InnerExceptions[0].Message);

        Assert.Equal("Error while validating the service descriptor 'ServiceType: MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+IFoo Lifetime: Singleton ImplementationInstance: System.Object': " +
                     "Constant value of type 'System.Object' can't be converted to service type 'MicrosoftCopy.DependencyInjection.Tests.ServiceProviderValidationTests+IFoo'",
            aggregateException.InnerExceptions[1].Message);
    }
