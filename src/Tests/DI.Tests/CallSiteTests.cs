...
public class CallSiteTests
{
    ...
    {
        var provider = new MicrosoftServiceProvider(descriptors, ServiceProviderOptions.Default);
    ...
    private void NoServiceCallsite_DefaultValueNull_DoesNotThrow(ServiceProviderMode mode)
    {
        ...
        var instance = ActivatorUtilities.CreateInstance<ServiceF>(provider);
    ...
    private static Func<ServiceProviderEngineScope, object> CompileCallSite(ServiceCallSite callSite, MicrosoftServiceProvider provider)
    {
