...
using RonSijm.Syringe.Fluxor.Tests.Redux;
...
public class TestFeatureShouldTriggerUpdate_AddFluxorThroughServiceCollection
{
    ...
    private static async Task<SyringeServiceProvider> CreateServiceProvider()
    {
        ...
        serviceCollection.AddFluxorInternal(options =>
        {
            options.WithLifetime(StoreLifetime.Singleton)
                .ScanAssemblies(typeof(TestFeatureShouldTriggerUpdate_AddFluxorThroughServiceCollection).Assembly)
