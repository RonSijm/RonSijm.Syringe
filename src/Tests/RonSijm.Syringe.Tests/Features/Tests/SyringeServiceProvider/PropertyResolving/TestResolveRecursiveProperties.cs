...
public class TestResolveRecursiveProperties
{
    ...
    protected IServiceProvider SetupServiceProvider()
    {
        ...
        var serviceProvider = serviceCollection.BuildSyringeServiceProvider(options => options.WithAfterGetServiceExtension(new PropertyInjectionAfterServiceExtension()));
